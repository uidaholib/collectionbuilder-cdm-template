...
{% include feature/card.md text="potlatchnow" %}
...
{% capture nameorigin %}
As of April 2020, the history page on the PotlatchDeltic website says that the name "'Potlatch' was borrowed from the Chinook word for a Native American celebration of goodwill and gift giving."[^1]
{% endcapture %}

{% include feature/card.md text="nameorigin" %}
