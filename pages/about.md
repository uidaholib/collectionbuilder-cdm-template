...
{% endcapture %}
{:.text-center}
{% include feature/card.md text=exampletext centered="true" width="50" %}
...
{% include feature/card.md text=card3 header="Pre-NCAA" centered="true" width="50"%}
{% include feature/card.md text=card4 header="NCAA Division I-AA (now FCS), 1978-1995" centered="true" width="50"%}
{% include feature/card.md text=card5 header="NCAA Division I-A (now FBS), 1996-2017" centered="true" width="50"%}
{% include feature/card.md text=card6 header="NCAA FCS (formerly I-AA), 2018 - present" centered="true" width="50"%}
...
<div class="row">
<div class="col-md-4">
{% include feature/item-figure.html objectid="https://digital.lib.uidaho.edu/digital/api/singleitem/image/pg1/273/default.jpg
" caption="MacLean Field, football practice, 1922" link="https://digital.lib.uidaho.edu/digital/collection/pg1/id/273" %}
</div>
<div class="col-md-4">
{% include feature/item-figure.html objectid="https://digital.lib.uidaho.edu/digital/api/singleitem/image/pg1/1899/default.jpg" caption="Neale Stadium, 1940" link="https://digital.lib.uidaho.edu/digital/collection/pg1/id/1899" %}
</div>
<div class="col-md-4">
